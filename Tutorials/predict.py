...
try:
    ...
    print(image_path,'--image selected')
except:
    sys.exit("--filepath option needs to be used...")
training_dir=args.trainpath
if args.trainpath==None:
    sys.exit("--trainpath needs to be used for the used training data directory")
